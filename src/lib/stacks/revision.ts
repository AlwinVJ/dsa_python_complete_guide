...
export const STACK_REVISION: StackLesson[] = [
  ...
  },
  {
    ...
    eyebrow: "Review · 2",
    description: "Jump to the full FAQ — same questions learners ask most, curated with code and complexity.",
    difficulty: "Beginner",
    readMinutes: 2,
    sections: [
      { type: "callout", kind: "info", title: "Full FAQ lives on a dedicated page",
  ...
  },
  {
    ...
    eyebrow: "Review · 3",
    description: "Jump to the full interview bank — 20+ questions from theory to FAANG monotonic-stack problems.",
    ...
    sections: [
      { type: "practice", groups: [
        { level: "Beginner", items: [
          { title: "LC 20 · Valid Parentheses", url: "https://leetcode.com/problems/valid-parentheses/", difficulty: "Easy" },
        ...
        { level: "Intermediate", items: [
          { title: "LC 155 · Min Stack", url: "https://leetcode.com/problems/min-stack/", difficulty: "Medium" },
          { title: "LC 150 · Evaluate Reverse Polish Notation", url: "https://leetcode.com/problems/evaluate-reverse-polish-notation/", difficulty: "Medium" },
          ...
          { title: "LC 394 · Decode String", url: "https://leetcode.com/problems/decode-string/", difficulty: "Medium" },
        ...
        { level: "Advanced", items: [
          ...
          { title: "LC 32 · Longest Valid Parentheses", url: "https://leetcode.com/problems/longest-valid-parentheses/", difficulty: "Hard" },
        ]},
      ]},
    ],
  },
  ...
  },
  {
    ...
    sections: [
      { type: "references", items: [
        { label: "HackerRank · Stacks (all problems)", url: "https://www.hackerrank.com/domains/data-structures?filters%5Bsubdomains%5D%5B%5D=stacks" },
        { label: "HackerRank · Balanced Brackets", url: "https://www.hackerrank.com/challenges/balanced-brackets/problem" },
        { label: "HackerRank · Largest Rectangle", url: "https://www.hackerrank.com/challenges/largest-rectangle/problem" },
        { label: "HackerRank · Poisonous Plants", url: "https://www.hackerrank.com/challenges/poisonous-plants/problem" },
      ]},
    ],
  },
  {
    ...
    sections: [
      { type: "references", items: [
        { label: "Stack (abstract data type) — Wikipedia", url: "https://en.wikipedia.org/wiki/Stack_(abstract_data_type)" },
        { label: "CPython source · listobject.c (list.pop internals)", url: "https://github.com/python/cpython/blob/main/Objects/listobject.c" },
        { label: "Python docs · using lists as stacks", url: "https://docs.python.org/3/tutorial/datastructures.html#using-lists-as-stacks" },
        { label: "MIT 6.006 · Stacks & Queues (lecture notes)", url: "https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/" },
    ...
    sections: [
      { type: "quiz", items: [
        { q: "Which operation is NOT O(1) on a Python-list-backed stack?",
          choices: ["append", "pop", "pop(0)", "list[-1]"], answer: 2,
          explain: "pop(0) shifts every remaining element — O(n)." },
        { q: "What is the acronym describing stack ordering?",
          choices: ["FIFO", "LIFO", "LRU", "LILO"], answer: 1 },
        { q: "Popping an empty stack raises which exception?",
          choices: ["ValueError", "KeyError", "IndexError", "TypeError"], answer: 2 },
        { q: "Which structure is most naturally implemented with a stack?",
          choices: ["Round-robin scheduler", "Depth-first search", "Breadth-first search", "Print queue"], answer: 1 },
        { q: "The stack pointer typically points to…",
          choices: ["the current top", "the next free slot", "the base", "the middle"], answer: 1 },
        { q: "Two stacks can implement a…",
          choices: ["Hash map", "Queue", "Priority queue", "Trie"], answer: 1 },
        { q: "Min-stack achieves O(1) getMin by storing…",
          choices: ["a heap", "(value, running_min) pairs", "sorted values", "a BST"], answer: 1 },
        { q: "The monotonic stack solves problems of the shape…",
          choices: ["shortest path", "next greater / smaller element", "in-order traversal", "cycle detection"], answer: 1 },
        { q: "Python's default recursion limit is roughly…",
          choices: ["100", "1000", "10 000", "100 000"], answer: 1 },
        { q: "Which is TRUE about a stack?",
          choices: ["Random access is O(1)", "Insertion at the middle is O(1)", "All core ops are O(1)", "Search is O(log n)"], answer: 2 },
      ]},
    ],
  },
  {
    ...
    sections: [
      { type: "theory", text:
        "Queues are the LIFO-vs-FIFO mirror of everything you just learned. Same primitives, opposite ordering. After Queues comes Hash Tables — the last of the linear data structures — and then the non-linear world of Trees and Graphs." },
      { type: "callout", kind: "did", title: "Recommended next course",
