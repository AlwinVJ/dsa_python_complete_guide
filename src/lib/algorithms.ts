...
export const ALGORITHMS: Algorithm[] = [
  // 1
  {
    ...
    leetcode: [
      { id: "1108", title: "Defanging an IP Address", difficulty: "Easy", url: "https://leetcode.com/problems/defanging-an-ip-address/", minutes: 5 },
      { id: "1512", title: "Number of Good Pairs", difficulty: "Easy", url: "https://leetcode.com/problems/number-of-good-pairs/", minutes: 10 },
      { id: "1365", title: "How Many Numbers Are Smaller Than the Current", difficulty: "Easy", url: "https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/", minutes: 15 },
      { id: "485", title: "Max Consecutive Ones", difficulty: "Easy", url: "https://leetcode.com/problems/max-consecutive-ones/", minutes: 15 },
      { id: "283", title: "Move Zeroes", difficulty: "Easy", url: "https://leetcode.com/problems/move-zeroes/", minutes: 20 },
    ],
  },
  ...
  // 2
  {
    ...
    leetcode: [
      { id: "167", title: "Two Sum II - Input Array Is Sorted", difficulty: "Easy", url: "https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/", minutes: 15 },
      { id: "26", title: "Remove Duplicates from Sorted Array", difficulty: "Easy", url: "https://leetcode.com/problems/remove-duplicates-from-sorted-array/", minutes: 15 },
      { id: "283", title: "Move Zeroes", difficulty: "Easy", url: "https://leetcode.com/problems/move-zeroes/", minutes: 15 },
      { id: "125", title: "Valid Palindrome", difficulty: "Easy", url: "https://leetcode.com/problems/valid-palindrome/", minutes: 15 },
      { id: "977", title: "Squares of a Sorted Array", difficulty: "Easy", url: "https://leetcode.com/problems/squares-of-a-sorted-array/", minutes: 20 },
      { id: "11", title: "Container With Most Water", difficulty: "Medium", url: "https://leetcode.com/problems/container-with-most-water/", minutes: 25 },
      { id: "15", title: "3Sum", difficulty: "Medium", url: "https://leetcode.com/problems/3sum/", minutes: 40 },
      { id: "42", title: "Trapping Rain Water", difficulty: "Hard", url: "https://leetcode.com/problems/trapping-rain-water/", minutes: 45 },
    ],
  },
  ...
  // 3
  {
    ...
    leetcode: [
      { id: "643", title: "Maximum Average Subarray I", difficulty: "Easy", url: "https://leetcode.com/problems/maximum-average-subarray-i/", minutes: 15 },
      { id: "1004", title: "Max Consecutive Ones III", difficulty: "Medium", url: "https://leetcode.com/problems/max-consecutive-ones-iii/", minutes: 30 },
      { id: "3", title: "Longest Substring Without Repeating Characters", difficulty: "Medium", url: "https://leetcode.com/problems/longest-substring-without-repeating-characters/", minutes: 30 },
      { id: "209", title: "Minimum Size Subarray Sum", difficulty: "Medium", url: "https://leetcode.com/problems/minimum-size-subarray-sum/", minutes: 25 },
      { id: "76", title: "Minimum Window Substring", difficulty: "Hard", url: "https://leetcode.com/problems/minimum-window-substring/", minutes: 50 },
    ],
  },
...
def range_sum(p, l, r):
    ...
    leetcode: [
      { id: "1480", title: "Running Sum of 1d Array", difficulty: "Easy", url: "https://leetcode.com/problems/running-sum-of-1d-array/", minutes: 10 },
      { id: "724", title: "Find Pivot Index", difficulty: "Easy", url: "https://leetcode.com/problems/find-pivot-index/", minutes: 15 },
      { id: "303", title: "Range Sum Query - Immutable", difficulty: "Easy", url: "https://leetcode.com/problems/range-sum-query-immutable/", minutes: 15 },
      { id: "560", title: "Subarray Sum Equals K", difficulty: "Medium", url: "https://leetcode.com/problems/subarray-sum-equals-k/", minutes: 30 },
      { id: "974", title: "Subarray Sums Divisible by K", difficulty: "Medium", url: "https://leetcode.com/problems/subarray-sums-divisible-by-k/", minutes: 35 },
      { id: "304", title: "Range Sum Query 2D - Immutable", difficulty: "Medium", url: "https://leetcode.com/problems/range-sum-query-2d-immutable/", minutes: 40 },
    ],
  },
  ...
  // 5
  {
    ...
    leetcode: [
      { id: "1", title: "Two Sum", difficulty: "Easy", url: "https://leetcode.com/problems/two-sum/", minutes: 15 },
      { id: "169", title: "Majority Element", difficulty: "Easy", url: "https://leetcode.com/problems/majority-element/", minutes: 20 },
      { id: "217", title: "Contains Duplicate", difficulty: "Easy", url: "https://leetcode.com/problems/contains-duplicate/", minutes: 10 },
      { id: "49", title: "Group Anagrams", difficulty: "Medium", url: "https://leetcode.com/problems/group-anagrams/", minutes: 25 },
      { id: "347", title: "Top K Frequent Elements", difficulty: "Medium", url: "https://leetcode.com/problems/top-k-frequent-elements/", minutes: 30 },
      { id: "128", title: "Longest Consecutive Sequence", difficulty: "Medium", url: "https://leetcode.com/problems/longest-consecutive-sequence/", minutes: 30 },
    ],
  },
  ...
  // 6
  {
    ...
    leetcode: [
      { id: "704", title: "Binary Search", difficulty: "Easy", url: "https://leetcode.com/problems/binary-search/", minutes: 15 },
      { id: "35", title: "Search Insert Position", difficulty: "Easy", url: "https://leetcode.com/problems/search-insert-position/", minutes: 15 },
      { id: "278", title: "First Bad Version", difficulty: "Easy", url: "https://leetcode.com/problems/first-bad-version/", minutes: 20 },
      { id: "162", title: "Find Peak Element", difficulty: "Medium", url: "https://leetcode.com/problems/find-peak-element/", minutes: 25 },
      { id: "33", title: "Search in Rotated Sorted Array", difficulty: "Medium", url: "https://leetcode.com/problems/search-in-rotated-sorted-array/", minutes: 30 },
      { id: "34", title: "Find First and Last Position of Element", difficulty: "Medium", url: "https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/", minutes: 30 },
      { id: "875", title: "Koko Eating Bananas", difficulty: "Medium", url: "https://leetcode.com/problems/koko-eating-bananas/", minutes: 35 },
    ],
  },
  ...
  // 7
  {
    ...
    complexity: { best: "O(n log n)", average: "O(n log n)", worst: "O(n log n)", space: "O(n) auxiliary (Timsort)" },
    code: [
      {
    ...
    leetcode: [
      { id: "56", title: "Merge Intervals", difficulty: "Medium", url: "https://leetcode.com/problems/merge-intervals/", minutes: 25 },
      { id: "252", title: "Meeting Rooms", difficulty: "Easy", url: "https://leetcode.com/problems/meeting-rooms/", minutes: 15 },
      { id: "253", title: "Meeting Rooms II", difficulty: "Medium", url: "https://leetcode.com/problems/meeting-rooms-ii/", minutes: 30 },
      { id: "973", title: "K Closest Points to Origin", difficulty: "Medium", url: "https://leetcode.com/problems/k-closest-points-to-origin/", minutes: 25 },
      { id: "1200", title: "Minimum Absolute Difference", difficulty: "Easy", url: "https://leetcode.com/problems/minimum-absolute-difference/", minutes: 15 },
    ],
  },
  ...
  // 8
  {
    ...
    leetcode: [
      { id: "53", title: "Maximum Subarray", difficulty: "Medium", url: "https://leetcode.com/problems/maximum-subarray/", minutes: 20 },
      { id: "918", title: "Maximum Sum Circular Subarray", difficulty: "Medium", url: "https://leetcode.com/problems/maximum-sum-circular-subarray/", minutes: 30 },
      { id: "152", title: "Maximum Product Subarray", difficulty: "Medium", url: "https://leetcode.com/problems/maximum-product-subarray/", minutes: 30 },
      { id: "978", title: "Longest Turbulent Subarray", difficulty: "Medium", url: "https://leetcode.com/problems/longest-turbulent-subarray/", minutes: 30 },
    ],
  },
  ...
  // 9
  {
    ...
    tagline: "Make the locally optimal choice at each step — when it provably leads to the global optimum.",
    category: "Greedy",
    whyItExists:
    ...
    leetcode: [
      { id: "55", title: "Jump Game", difficulty: "Medium", url: "https://leetcode.com/problems/jump-game/", minutes: 25 },
      { id: "45", title: "Jump Game II", difficulty: "Medium", url: "https://leetcode.com/problems/jump-game-ii/", minutes: 30 },
      { id: "134", title: "Gas Station", difficulty: "Medium", url: "https://leetcode.com/problems/gas-station/", minutes: 30 },
      { id: "455", title: "Assign Cookies", difficulty: "Easy", url: "https://leetcode.com/problems/assign-cookies/", minutes: 15 },
      { id: "135", title: "Candy", difficulty: "Hard", url: "https://leetcode.com/problems/candy/", minutes: 40 },
    ],
  },
  ...
  // 10
  {
    ...
    complexity: { best: "O(n log n)", average: "O(n log n)", worst: "O(n log n)", space: "O(n) or O(log n) recursion" },
    code: [
      {
        label: "Merge sort",
...
def merge(a, b):
    ...
    leetcode: [
      { id: "912", title: "Sort an Array", difficulty: "Medium", url: "https://leetcode.com/problems/sort-an-array/", minutes: 30 },
      { id: "53", title: "Maximum Subarray (D&C variant)", difficulty: "Medium", url: "https://leetcode.com/problems/maximum-subarray/", minutes: 30 },
      { id: "148", title: "Sort List", difficulty: "Medium", url: "https://leetcode.com/problems/sort-list/", minutes: 40 },
      { id: "23", title: "Merge k Sorted Lists", difficulty: "Hard", url: "https://leetcode.com/problems/merge-k-sorted-lists/", minutes: 45 },
    ],
  },
  ...
  // 11
  {
    ...
    complexity: { best: "O(log n) push/pop", average: "O(log n)", worst: "O(log n)", space: "O(n)" },
    code: [
      {
...
def merge_k(lists):
    ...
    leetcode: [
      { id: "215", title: "Kth Largest Element in an Array", difficulty: "Medium", url: "https://leetcode.com/problems/kth-largest-element-in-an-array/", minutes: 25 },
      { id: "347", title: "Top K Frequent Elements", difficulty: "Medium", url: "https://leetcode.com/problems/top-k-frequent-elements/", minutes: 25 },
      { id: "703", title: "Kth Largest Element in a Stream", difficulty: "Easy", url: "https://leetcode.com/problems/kth-largest-element-in-a-stream/", minutes: 20 },
      { id: "23", title: "Merge k Sorted Lists", difficulty: "Hard", url: "https://leetcode.com/problems/merge-k-sorted-lists/", minutes: 45 },
      { id: "295", title: "Find Median from Data Stream", difficulty: "Hard", url: "https://leetcode.com/problems/find-median-from-data-stream/", minutes: 45 },
    ],
  },
  ...
  // 12
  {
    ...
    pythonTricks: [
      "Use a plain list as a stack — `.append` and `.pop()` are O(1).",
    ],
    whenNot: [
      "You need the greater element globally, not just the closest — sort or use a heap.",
    ],
    leetcode: [
      { id: "496", title: "Next Greater Element I", difficulty: "Easy", url: "https://leetcode.com/problems/next-greater-element-i/", minutes: 20 },
      { id: "739", title: "Daily Temperatures", difficulty: "Medium", url: "https://leetcode.com/problems/daily-temperatures/", minutes: 25 },
      { id: "901", title: "Online Stock Span", difficulty: "Medium", url: "https://leetcode.com/problems/online-stock-span/", minutes: 30 },
      { id: "84", title: "Largest Rectangle in Histogram", difficulty: "Hard", url: "https://leetcode.com/problems/largest-rectangle-in-histogram/", minutes: 45 },
      { id: "42", title: "Trapping Rain Water", difficulty: "Hard", url: "https://leetcode.com/problems/trapping-rain-water/", minutes: 40 },
    ],
  },
...
def max_sliding_window(nums, k):
    ...
    edgeCases: [
      ...
      "k = n — one output equal to max(nums).",
    ],
    interviewTips: [
    ...
    leetcode: [
      { id: "239", title: "Sliding Window Maximum", difficulty: "Hard", url: "https://leetcode.com/problems/sliding-window-maximum/", minutes: 35 },
      { id: "862", title: "Shortest Subarray with Sum at Least K", difficulty: "Hard", url: "https://leetcode.com/problems/shortest-subarray-with-sum-at-least-k/", minutes: 50 },
    ],
  },
  ...
  // 14
  {
    ...
    leetcode: [
      { id: "54", title: "Spiral Matrix", difficulty: "Medium", url: "https://leetcode.com/problems/spiral-matrix/", minutes: 30 },
      { id: "48", title: "Rotate Image", difficulty: "Medium", url: "https://leetcode.com/problems/rotate-image/", minutes: 25 },
      { id: "73", title: "Set Matrix Zeroes", difficulty: "Medium", url: "https://leetcode.com/problems/set-matrix-zeroes/", minutes: 30 },
      { id: "74", title: "Search a 2D Matrix", difficulty: "Medium", url: "https://leetcode.com/problems/search-a-2d-matrix/", minutes: 25 },
      { id: "36", title: "Valid Sudoku", difficulty: "Medium", url: "https://leetcode.com/problems/valid-sudoku/", minutes: 30 },
    ],
  },
  ...
  // 15
  {
    ...
    complexity: { best: "problem-dependent", average: "O(n · 2^n) subsets", worst: "O(n · n!) permutations", space: "O(n) recursion" },
    code: [
      {
        label: "Subsets",
    ...
    leetcode: [
      { id: "78", title: "Subsets", difficulty: "Medium", url: "https://leetcode.com/problems/subsets/", minutes: 25 },
      { id: "46", title: "Permutations", difficulty: "Medium", url: "https://leetcode.com/problems/permutations/", minutes: 25 },
      { id: "39", title: "Combination Sum", difficulty: "Medium", url: "https://leetcode.com/problems/combination-sum/", minutes: 30 },
      { id: "77", title: "Combinations", difficulty: "Medium", url: "https://leetcode.com/problems/combinations/", minutes: 25 },
      { id: "51", title: "N-Queens", difficulty: "Hard", url: "https://leetcode.com/problems/n-queens/", minutes: 45 },
    ],
  },
  ...
  // 16
  {
    ...
    edgeCases: [
      "Empty list — XOR identity is 0.",
      "All duplicates — XOR result is 0.",
    ],
    interviewTips: [
    ...
    leetcode: [
      { id: "136", title: "Single Number", difficulty: "Easy", url: "https://leetcode.com/problems/single-number/", minutes: 15 },
      { id: "268", title: "Missing Number", difficulty: "Easy", url: "https://leetcode.com/problems/missing-number/", minutes: 15 },
      { id: "191", title: "Number of 1 Bits", difficulty: "Easy", url: "https://leetcode.com/problems/number-of-1-bits/", minutes: 15 },
      { id: "260", title: "Single Number III", difficulty: "Medium", url: "https://leetcode.com/problems/single-number-iii/", minutes: 30 },
      { id: "78", title: "Subsets (bitmask variant)", difficulty: "Medium", url: "https://leetcode.com/problems/subsets/", minutes: 25 },
    ],
  },
  ...
  // 17
  {
    ...
    leetcode: [
      { id: "56", title: "Merge Intervals", difficulty: "Medium", url: "https://leetcode.com/problems/merge-intervals/", minutes: 25 },
      { id: "57", title: "Insert Interval", difficulty: "Medium", url: "https://leetcode.com/problems/insert-interval/", minutes: 30 },
      { id: "435", title: "Non-overlapping Intervals", difficulty: "Medium", url: "https://leetcode.com/problems/non-overlapping-intervals/", minutes: 30 },
      { id: "253", title: "Meeting Rooms II", difficulty: "Medium", url: "https://leetcode.com/problems/meeting-rooms-ii/", minutes: 35 },
    ],
  },
  ...
  // 18
  {
    ...
    realWorld: [
      "Small-domain data validation (bounded IDs).",
    ],
    ...
    leetcode: [
      { id: "268", title: "Missing Number", difficulty: "Easy", url: "https://leetcode.com/problems/missing-number/", minutes: 15 },
      { id: "448", title: "Find All Numbers Disappeared", difficulty: "Easy", url: "https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array/", minutes: 25 },
      { id: "287", title: "Find the Duplicate Number", difficulty: "Medium", url: "https://leetcode.com/problems/find-the-duplicate-number/", minutes: 30 },
      { id: "442", title: "Find All Duplicates in an Array", difficulty: "Medium", url: "https://leetcode.com/problems/find-all-duplicates-in-an-array/", minutes: 25 },
      { id: "41", title: "First Missing Positive", difficulty: "Hard", url: "https://leetcode.com/problems/first-missing-positive/", minutes: 40 },
    ],
  },
  ...
  // 19
  {
    ...
    complexity: { best: "O(n)", average: "O(n)", worst: "O(n²) worst case", space: "O(1) with iterative partition, O(log n) recursion" },
    code: [
      {
...
def quickselect(nums, k):
    ...
    leetcode: [
      { id: "215", title: "Kth Largest Element in an Array", difficulty: "Medium", url: "https://leetcode.com/problems/kth-largest-element-in-an-array/", minutes: 30 },
      { id: "973", title: "K Closest Points to Origin", difficulty: "Medium", url: "https://leetcode.com/problems/k-closest-points-to-origin/", minutes: 30 },
      { id: "347", title: "Top K Frequent Elements", difficulty: "Medium", url: "https://leetcode.com/problems/top-k-frequent-elements/", minutes: 30 },
    ],
  },
  ...
  // 20
  {
    ...
    complexity: { best: "problem-dependent", average: "O(n) or O(n·k)", worst: "same", space: "O(n) → O(1) with rolling variables" },
    code: [
      {
...
def fib(n):
    ...
    leetcode: [
      { id: "70", title: "Climbing Stairs", difficulty: "Easy", url: "https://leetcode.com/problems/climbing-stairs/", minutes: 15 },
      { id: "509", title: "Fibonacci Number", difficulty: "Easy", url: "https://leetcode.com/problems/fibonacci-number/", minutes: 10 },
      { id: "198", title: "House Robber", difficulty: "Medium", url: "https://leetcode.com/problems/house-robber/", minutes: 25 },
      { id: "213", title: "House Robber II", difficulty: "Medium", url: "https://leetcode.com/problems/house-robber-ii/", minutes: 30 },
      { id: "746", title: "Min Cost Climbing Stairs", difficulty: "Easy", url: "https://leetcode.com/problems/min-cost-climbing-stairs/", minutes: 20 },
      { id: "300", title: "Longest Increasing Subsequence", difficulty: "Medium", url: "https://leetcode.com/problems/longest-increasing-subsequence/", minutes: 35 },
    ],
  },
];
