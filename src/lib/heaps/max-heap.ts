...
export const H_MAX_HEAP: HLesson[] = [
  {
    ...
    eyebrow: "Max Heap · 1",
    description: "Flip the comparison and the largest value now lives at the root — same shape, same math, opposite ordering.",
    difficulty: "Beginner",
    readMinutes: 3,
    sections: [
      { type: "theory", text: "A max-heap is a complete binary tree where every parent is ≥ each of its children. The root holds the largest value. Everything you learned about min-heaps applies here — insertion, deletion, heapify, and complexity are unchanged. Only the comparison direction flips." },
      { type: "heapViz", data: [50, 30, 40, 10, 20, 35, 25], kind: "max",
        caption: "Root 50 is the maximum. Every downward edge points to a value ≤ its parent." },
      { type: "callout", kind: "info", title: "Python doesn't ship one",
  ...
  },
  {
    ...
    title: "Structure",
    eyebrow: "Max Heap · 2",
    description: "Same complete-binary-tree shape and array packing as the min-heap — only the invariant flips.",
    difficulty: "Beginner",
    readMinutes: 2,
    sections: [
      { type: "theory", bullets: [
  ...
  },
  {
    ...
    eyebrow: "Max Heap · 3",
    description: "Push, pop, and heapify use the same choreography — only the direction of every comparison flips.",
    difficulty: "Beginner",
    readMinutes: 3,
    sections: [
      { type: "table", headers: ["Min-heap", "Max-heap"], rows: [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "code", title: "negation.py", code:
`import heapq
...
pop_max(h)   # 5` },
      { type: "callout", kind: "warn", title: "Non-numeric values?",
      ...
      { type: "code", title: "max_heap.py", code:
`class MaxHeap:
  ...
  },
  {
    ...
    title: "Insert",
    eyebrow: "Max Heap · 5",
    description: "Append + sift-up with a flipped comparator — the value stops rising the moment it's ≤ its parent.",
    difficulty: "Beginner",
    readMinutes: 4,
    sections: [
  ...
  },
  {
    ...
    title: "Delete Root",
    eyebrow: "Max Heap · 6",
    description: "Extract-max mirrors extract-min: swap root with last, pop tail, sift-down toward the larger child.",
    difficulty: "Beginner",
    readMinutes: 3,
    sections: [
...
`def sift_down_max(a, i):
  ...
  },
  {
    ...
    eyebrow: "Max Heap · 10",
    description: "Bottom-up sift-down — still O(n), still the fastest way to convert an unordered list to a heap.",
    difficulty: "Intermediate",
    readMinutes: 3,
    sections: [
...
`def build_max_heap(a):
  ...
  },
  {
    ...
    title: "Complexity",
    eyebrow: "Max Heap · 11",
    description: "Identical to the min-heap — the flipped comparator changes semantics, not asymptotics.",
    difficulty: "Beginner",
    readMinutes: 2,
    sections: [
    ...
    sections: [
      { type: "practice", groups: [
        ...
        { level: "Intermediate", items: [
          { title: "LC 1642 · Furthest Building You Can Reach", url: "https://leetcode.com/problems/furthest-building-you-can-reach/", difficulty: "Medium", pattern: "Greedy + max-heap" },
  ...
  },
  {
    ...
    sections: [
      { type: "references", items: [
        { label: "Python heapq — max-heap tricks", url: "https://docs.python.org/3/library/heapq.html#basic-examples" },
        { label: "GeeksforGeeks · Max Heap in Python", url: "https://www.geeksforgeeks.org/max-heap-in-python/" },
