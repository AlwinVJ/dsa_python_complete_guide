  ...
  lessons: [
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "theory", text: "A general (n-ary) tree lets every node hold an arbitrary list of children. It's the raw hierarchy — no ordering, no balancing, no fan-out cap. File systems, DOM trees, and JSON documents are general trees." },
        { type: "tree", root: {
          id: "/", label: "/", color: "brand",
          children: [
            { id: "u", label: "usr", children: [{ id: "b", label: "bin" }, { id: "l", label: "lib" }, { id: "s", label: "share" }]},
            { id: "e", label: "etc", children: [{ id: "n", label: "nginx" }, { id: "sys", label: "systemd" }]},
            { id: "h", label: "home", children: [{ id: "a", label: "alice" }, { id: "bo", label: "bob" }]},
          ],
    ...
    },
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "code", title: "n-ary node in Python", code:
`class NTreeNode:
    ...
    def add(self, child):
        ...
        { type: "callout", kind: "tip", title: "Why a list?",
    ...
    },
    {
      ...
      description: "Three common encodings — list of children, parent array, and first-child-next-sibling.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        { type: "table", headers: ["Encoding", "When to use"], rows: [
          ...
          ["First-child / next-sibling", "Fixed-size nodes, unbounded fan-out with only two pointers each."],
        ]},
        { type: "code", title: "parent array", code:
`# tree with 5 nodes, parent[i] = parent of i (or -1 for root)
parent = [-1, 0, 0, 1, 1]
# node 0 is root; 1 and 2 are its children; 3 and 4 are children of 1.` },
    ...
    },
    {
      ...
      readMinutes: 4,
      sections: [
        { type: "code", title: "DFS and BFS", code:
`def dfs(node, visit):
    if not node: return
    visit(node.val)
...
def bfs(root, visit):
    ...
    },
    {
      ...
      description: "General trees carry no balance guarantee — everything is proportional to the shape.",
      difficulty: "Beginner",
      readMinutes: 2,
      sections: [
      ...
      sections: [
        { type: "practice", groups: [
          { level: "Beginner", items: [
            { title: "LC 589 · N-ary Tree Preorder Traversal", url: "https://leetcode.com/problems/n-ary-tree-preorder-traversal/", difficulty: "Easy" },
            { title: "LC 590 · N-ary Tree Postorder Traversal", url: "https://leetcode.com/problems/n-ary-tree-postorder-traversal/", difficulty: "Easy" },
          ]},
          { level: "Intermediate", items: [
            { title: "LC 429 · N-ary Level Order Traversal", url: "https://leetcode.com/problems/n-ary-tree-level-order-traversal/", difficulty: "Medium" },
            { title: "LC 559 · Max Depth of N-ary Tree", url: "https://leetcode.com/problems/maximum-depth-of-n-ary-tree/", difficulty: "Easy" },
          ]},
        ]},
      ],
    },
      ...
      sections: [
        { type: "quiz", items: [
          { q: "Which representation stores each node's parent index in a flat array?",
            choices: ["List of children", "Parent array", "First-child next-sibling", "Adjacency matrix"],
            answer: 1, explain: "Parent arrays are minimal and fast for union-find style problems." },
        ]},
      ],
    },
    {
      ...
      sections: [
        { type: "references", items: [
          ...
          { label: "Python Docs — os.walk", url: "https://docs.python.org/3/library/os.html#os.walk" },
        ]},
      ],
    },
  ],
  ...
  lessons: [
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "theory", text: "A binary tree is the most studied tree in computer science. It's the foundation for BSTs, heaps, expression trees, Huffman coding, and almost every tree question you'll ever be asked in an interview." },
        { type: "tree", root: {
          id: 1, label: 1, color: "brand",
          children: [
            { id: 2, label: 2, children: [{ id: 4, label: 4 }, { id: 5, label: 5 }]},
            { id: 3, label: 3, children: [{ id: 6, label: 6 }, { id: 7, label: 7 }]},
          ],
        }, caption: "A complete binary tree of depth 2." },
        { type: "heading", text: "Build one yourself" },
        { type: "binaryPlayground", caption: "Click Add to attach children, then classify each node as leaf / internal." },
      ],
    ...
    },
    {
      ...
      description: "Full, complete, perfect, balanced, degenerate — five shapes with strict definitions.",
      difficulty: "Beginner",
      readMinutes: 5,
      sections: [
        { type: "table", headers: ["Type", "Definition"], rows: [
          ...
          ["Degenerate (skewed)", "Every node has exactly one child — a linked list wearing a tree costume."],
        ]},
      ],
    },
    {
      ...
      description: "Every level full except the last, which fills strictly left-to-right — heaps are built on this shape.",
      difficulty: "Beginner",
      readMinutes: 3,
      sections: [
        { type: "tree", root: {
        ...
        { type: "theory", text: "Complete binary trees pack perfectly into an array: no wasted slots, cache-friendly, and children live at 2i+1 / 2i+2." },
        { type: "heading", text: "Drag the slider to grow it" },
        { type: "completeViz", count: 7, caption: "Adjust node count; the next-slot indicator shows where a level-order insert would land." },
      ],
    ...
    },
    {
      ...
      description: "Every internal node has exactly two children AND every leaf shares the same depth.",
      difficulty: "Beginner",
      readMinutes: 2,
      sections: [
        { type: "theory", text: "A perfect tree of height h has exactly 2^(h+1) − 1 nodes and 2^h leaves. Rare in the real world but perfect for reasoning about worst-case sizes." },
        { type: "perfectViz", levels: 3, caption: "Adjust height h — count updates to 2^(h+1) − 1 nodes." },
      ],
    ...
    },
    {
      ...
      readMinutes: 2,
      sections: [
        { type: "theory", text: "Also called a strict binary tree. Expression trees and Huffman codes are always full — every internal node combines two subtrees." },
        { type: "fullViz", caption: "Nodes with exactly one child are highlighted as rule breakers." },
      ],
    ...
    },
    {
      ...
      description: "Height difference between the two children ≤ 1 at every node — the property AVL enforces.",
      difficulty: "Intermediate",
      readMinutes: 3,
      sections: [
        { type: "code", title: "check balance in O(n)", code:
`def is_balanced(root):
    def h(n):
        ...
        return 1 + max(l, r)
    return h(root) >= 0` },
        { type: "balancedViz", caption: "Every node shows its live balance factor; unbalanced nodes flash red." },
      ],
    ...
    },
    {
      ...
      description: "Every node has one child — the pathological shape that turns tree ops into O(n).",
      difficulty: "Beginner",
      readMinutes: 2,
      sections: [
        { type: "tree", root: { id: 1, label: 1, color: "brand", children: [
          { id: 2, label: 2, children: [{ id: 3, label: 3, children: [{ id: 4, label: 4 }]}]},
        ]}, caption: "Left-skewed tree — height = n − 1." },
        { type: "callout", kind: "warn", text: "Inserting a sorted sequence into a plain BST produces exactly this shape." },
        { type: "degenerateViz", caption: "Watch a sorted BST insertion deform into a linked list." },
      ],
    ...
    },
    {
      ...
      readMinutes: 5,
      sections: [
        { type: "code", title: "from a level-order list", code:
`def build(values):
    ...
    },
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "code", title: "node object", code:
`class TreeNode:
    ...
    def __init__(self, val=0, left=None, right=None):
        ...
        ], caption: "Each node is a heap-allocated object with two pointers; addresses are stable for a given id." },
      ],
    ...
    },
    {
      ...
      description: "Insertion in a plain binary tree — usually at the first empty slot in level order.",
      difficulty: "Intermediate",
      readMinutes: 3,
      sections: [
        { type: "code", title: "level-order insert (iterative)", code:
`from collections import deque
def insert(root, val):
    node = TreeNode(val)
    ...
    return root` },
        { type: "code", title: "recursive variant (fills leftmost missing slot)", code:
`def insert_rec(root, val):
    ...
    return root` },
        { type: "dryRun", caption: "Insert 6 into [1,2,3,4,5] level-order",
    ...
    },
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "code", title: "level-order delete", code:
`from collections import deque
def delete(root, key):
    ...
    },
    {
      ...
      readMinutes: 2,
      sections: [
        { type: "code", title: "recursive contains", code:
`def contains(node, target):
    if not node: return False
    if node.val == target: return True
    return contains(node.left, target) or contains(node.right, target)` },
        { type: "code", title: "iterative BFS variant", code:
`from collections import deque
def contains_iter(root, target):
    ...
    },
    {
      ...
      sections: [
        { type: "practice", groups: [
          { level: "Beginner", items: [
            { title: "LC 104 · Max Depth of Binary Tree", url: "https://leetcode.com/problems/maximum-depth-of-binary-tree/", difficulty: "Easy" },
          ...
          { level: "Intermediate", items: [
            { title: "LC 102 · Level Order Traversal", url: "https://leetcode.com/problems/binary-tree-level-order-traversal/", difficulty: "Medium" },
            { title: "LC 105 · Build from Preorder + Inorder", url: "https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/", difficulty: "Medium" },
          ]},
        ]},
      ],
    },
      ...
      sections: [
        { type: "quiz", items: [
          { q: "A tree where every node has either 0 or 2 children is called…",
            ...
            answer: 1, explain: "Full = strictly 0 or 2 children, no exceptions." },
        ]},
      ],
    },
    {
      ...
      sections: [
        { type: "references", items: [
          { label: "CLRS Chapter 12 — Binary Search Trees", url: "https://mitpress.mit.edu/9780262046305/" },
  ...
  lessons: [
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "theory", text: "A Binary Search Tree (BST) constrains every node: everything in the left subtree is smaller, everything in the right subtree is larger. That single invariant turns O(n) search into O(log n) when the tree is balanced." },
        { type: "tree", root: {
          id: 50, label: 50, color: "brand",
          children: [
            { id: 30, label: 30, children: [{ id: 20, label: 20 }, { id: 40, label: 40 }]},
            { id: 70, label: 70, children: [{ id: 60, label: 60 }, { id: 80, label: 80 }]},
          ],
        ...
        ], caption: "Each node holds a value and two pointers. Simulated addresses are stable per node id." },
      ],
    },
    {
      ...
      eyebrow: "BST · 1b",
      description: "A drop-in BST class with insert, search, delete, traversals, min/max, height, and validation.",
      difficulty: "Beginner",
      readMinutes: 6,
      sections: [
        { type: "theory", text: "Below is a self-contained, beginner-friendly BST class. Every method is commented so you can read it top-to-bottom. Paste it into a file and run — no external dependencies." },
        { type: "code", title: "bst.py — full implementation", code:
`from collections import deque
...
if __name__ == "__main__":
    ...
    },
    {
      ...
      sections: [
        ...
        { type: "callout", kind: "warn", title: "Common validation bug",
    ...
    },
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "theory", text: "Insertion is a single walk from the root. At each node we compare with the value being inserted and go left (smaller) or right (larger); when we fall off the tree we allocate a new leaf." },
        { type: "code", title: "recursive insert", code:
`def insert(root, v):
    if not root: return TreeNode(v)
    if v < root.val:  root.left  = insert(root.left,  v)
    elif v > root.val: root.right = insert(root.right, v)
    return root  # duplicates ignored` },
        { type: "code", title: "iterative insert (no recursion stack)", code:
`def insert_iter(root, v):
    if not root: return TreeNode(v)
    cur = root
    while True:
        ...
        if nxt is None:
            ...
            return root
        cur = nxt` },
        { type: "dryRun", headers: ["Step", "Current node", "Compare", "Action"], rows: [
          ["1", "50", "35 < 50", "go left"],
          ["2", "30", "35 > 30", "go right"],
          ["3", "40", "35 < 40", "go left"],
    ...
    },
    {
      ...
      readMinutes: 5,
      sections: [
        { type: "theory", text: "Deletion is the trickiest core BST operation. Three shapes to handle: a leaf (just detach), a node with one child (splice the child in), and a node with two children (copy the inorder successor's value in and delete the successor from the right subtree — which is guaranteed to have at most one child)." },
        { type: "code", title: "delete a value", code:
`def delete(root, v):
    if not root: return None
    ...
    return root` },
        { type: "dryRun", headers: ["Step", "State", "Compare", "Action"], rows: [
...
`def bst_max(root):
    ...
    },
    {
      ...
      readMinutes: 3,
      sections: [
        { type: "code", title: "bounds recursion", code:
`import math
def is_bst(node, lo=-math.inf, hi=math.inf):
    ...
    },
    {
      ...
      sections: [
        { type: "practice", groups: [
          { level: "Beginner", items: [
            { title: "LC 700 · Search in a BST", url: "https://leetcode.com/problems/search-in-a-binary-search-tree/", difficulty: "Easy" },
            { title: "LC 701 · Insert into a BST", url: "https://leetcode.com/problems/insert-into-a-binary-search-tree/", difficulty: "Medium" },
          ]},
          { level: "Intermediate", items: [
            { title: "LC 98 · Validate BST", url: "https://leetcode.com/problems/validate-binary-search-tree/", difficulty: "Medium" },
            { title: "LC 230 · Kth Smallest Element", url: "https://leetcode.com/problems/kth-smallest-element-in-a-bst/", difficulty: "Medium" },
            { title: "LC 235 · LCA of a BST", url: "https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/", difficulty: "Medium" },
          ]},
        ]},
      ],
    },
      ...
      sections: [
        { type: "quiz", items: [
          { q: "Inorder traversal of a BST returns values in what order?",
            ...
            answer: 2, explain: "L → root → R with L < root < R yields sorted output." },
        ]},
      ],
    },
    {
      ...
      sections: [
        { type: "references", items: [
          { label: "Sedgewick — BSTs (Algorithms)", url: "https://algs4.cs.princeton.edu/32bst/" },
