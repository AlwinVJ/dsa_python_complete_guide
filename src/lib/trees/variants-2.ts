  ...
  lessons: [
    {
      ...
      eyebrow: "AVL · 1",
      description:
        "A self-balancing BST that guarantees O(log n) height by rotating after every mutation.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        {
          type: "theory",
          text: "Named after Adelson-Velsky and Landis (1962), the AVL tree keeps its height within roughly 1.44 · log₂(n) by requiring that every node's balance factor — height(left) − height(right) — stay in {−1, 0, +1}.",
        },
        {
          type: "tree",
          root: {
            ...
            children: [
              {
                ...
                badge: "bf=0",
                children: [
                  { id: 10, label: 10, badge: "bf=0" },
                  { id: 25, label: 25, badge: "bf=0" },
                ],
              },
              {
                id: 40,
                ...
                badge: "bf=0",
                children: [
                  { id: 35, label: 35, badge: "bf=0" },
                  { id: 50, label: 50, badge: "bf=0" },
                ],
              },
            ],
          },
    ...
    },
    {
      ...
      eyebrow: "AVL · 2",
      description:
        "bf(n) = height(n.left) − height(n.right) — the number the AVL tree cares about above all others.",
      difficulty: "Intermediate",
      readMinutes: 3,
      sections: [
        {
...
# whose |bf| becomes 2 (an AVL invariant violation).`,
      ...
      sections: [
        {
          ...
          rows: [
            ...
            [
              ...
              "Left-rotate child, then right-rotate node",
            ],
            [
              "Right-Left (RL)",
              "Inserted into left subtree of right child",
              "Right-rotate child, then left-rotate node",
            ],
          ],
        },
      ],
    },
    {
      ...
      eyebrow: "AVL · 4",
      description:
        "Single right rotation — restores balance when the excess sits on the outer left.",
      difficulty: "Intermediate",
      readMinutes: 3,
      sections: [
        {
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `# unbalanced case: bf(node) = +2 and bf(node.left) = -1
...
return rotate_right(node)`,
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `# unbalanced case: bf(node) = -2 and bf(node.right) = +1
...
return rotate_left(node)`,
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "AVL deletion mirrors insertion but may trigger more rotations — each ancestor whose balance factor breaks must be rebalanced. The number of rotations is bounded by the height, so still O(log n).",
        },
      ],
    },
    {
          ...
          groups: [
            {
              ...
              items: [
                {
                  title: "LC 108 · Sorted Array to Balanced BST",
                  url: "https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/",
                  difficulty: "Easy",
                },
                {
                  title: "LC 1382 · Balance a BST",
          ...
          items: [
            {
              ...
              answer: 2,
              explain: "LR = rotate left on the child, then right on the node.",
            },
          ],
        },
      ],
...
export const V_RB: TreeVariantMeta = {
  ...
  tagline:
    "A looser self-balancing BST — used inside std::map, TreeMap, and the Linux CFS scheduler.",
  lessons: [
    {
      slug: "introduction",
      title: "Introduction",
          ...
          root: {
            ...
            children: [
              ...
              },
              {
                ...
                color: "red",
                children: [
                  { id: 25, label: 25, color: "black" },
                  { id: 40, label: 40, color: "black" },
                ],
              },
            ],
          },
          caption:
            "A valid RB tree — root black, no two reds adjacent, equal black-height on every root-to-NIL path.",
        },
        {
          type: "callout",
          kind: "interview",
          title: "Why RB and not AVL?",
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "A plain BST degenerates to a linked list on sorted input, taking O(n) per operation. AVL fixes this by re-balancing aggressively — but pays for it with more rotations and taller code. Red-Black trees answer 'can we bound the height cheaply, tolerating a bit of imbalance?'",
        },
        {
          type: "table",
          headers: ["Property", "AVL", "Red-Black"],
          rows: [
        ...
        },
        {
          type: "callout",
          kind: "info",
          text: "std::map, Java TreeMap, and the Linux kernel all picked Red-Black — a strong empirical signal that fewer rotations wins in general-purpose code.",
        },
      ],
    },
    {
      ...
      sections: [
        ...
        {
          type: "rbPlayground",
          caption: "Insert values and watch the invariants stay true after each fixup.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Every node stores a colour. Newly inserted nodes are always coloured red — inserting a black node would immediately break property 5 (black-height equality). Starting red only risks breaking property 4 (no red-red), which is cheap to fix.",
        },
        {
          type: "code",
          title: "Node class",
          code: `RED, BLACK = 0, 1  # sentinel constants
...
class RBNode:
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "The black-height of a node is the number of black nodes on any path from it (exclusive) down to a NIL leaf. Property 5 says every such path has the same black-height. This is what caps the height.",
        },
        {
          type: "table",
          headers: ["Node", "Colour", "Black-height"],
          rows: [
            ["20 (root)", "black", "2"],
            ["10, 30", "red", "2"],
            ["5, 15, 25, 40", "black", "1"],
        ...
        },
        {
          type: "callout",
          kind: "perf",
          text: "For any RB tree with n internal nodes, height ≤ 2·log₂(n+1). Proof sketch: the subtree rooted at any node with black-height b contains ≥ 2ᵇ − 1 internal nodes.",
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          type: "callout",
          kind: "info",
          text: "The parent pointer is what lets insert-fixup walk upward in O(1) per step. AVL trees can also skip it by returning values on the recursion stack.",
        },
      ],
    },
    {
      ...
      eyebrow: "Red-Black · 7",
      description:
        "Same left/right rotations as AVL — used sparingly to fix red-red or double-black cases.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        {
          type: "theory",
          text: "A rotation restructures three nodes in O(1) while preserving BST order. Left-rotate at x makes x the left child of its right child y. Right-rotate is the mirror.",
        },
        {
          type: "code",
          title: "left_rotate / right_rotate",
          code: `def left_rotate(T, x):
    y = x.right
    x.right = y.left
...
def right_rotate(T, x):
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "When a red node has a red parent AND a red uncle, we recolour: parent and uncle become black, grandparent becomes red, then recurse on the grandparent. No rotation needed. This is the fast path — most inserts finish here.",
        },
        {
          type: "table",
          headers: ["Before", "Action", "After"],
          rows: [
            ["Parent = red, Uncle = red", "Recolour up", "Parent + uncle black, grandparent red"],
            [
              "Parent = red, Uncle = black, node on outer side",
              "Single rotation + recolour",
              "Balanced",
            ],
            [
              "Parent = red, Uncle = black, node on inner side",
              "Two rotations + recolour",
              "Balanced",
            ],
          ],
        },
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Insert like a plain BST, colour the new node red, then call insert_fixup. Fixup climbs from the new node, handling the three cases above until either the parent turns black or we reach the root (which we then paint black).",
        },
        {
          type: "code",
          title: "insert + insert_fixup",
          code: `def insert(T, val):
    z = RBNode(val, RED)
    y, x = None, T.root
    while x:
        y = x
...
def insert_fixup(T, z):
    ...
    T.root.color = BLACK`,
        ...
        {
          type: "dryRun",
          caption: "Insert 10, 20, 30 into an empty tree",
          headers: ["Step", "Action", "Tree"],
          rows: [
            ["1", "Insert 10 (red), recolour root → black", "10(B)"],
            ["2", "Insert 20 (red) as right child of 10", "10(B) → 20(R)"],
            [
              "3",
              "Insert 30 (red) as right child of 20 — red-red violation with parent 20",
              "unbalanced",
            ],
            [
              "4",
              "Case 3 (uncle is NIL/black, outer side): left-rotate at 10, swap colours 10↔20",
              "20(B) with 10(R) left, 30(R) right",
            ],
          ],
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Deletion mirrors BST deletion but must repair black-height if the removed (or replacement) node was black. We model the deficit by giving the replacement an extra 'black' — a 'double-black' — then eliminate it via four cases based on the sibling's colour and its children.",
        },
        {
          type: "code",
          title: "delete_fixup — the four cases",
          code: `def delete_fixup(T, x):
    ...
    if x: x.color = BLACK`,
        },
        {
          type: "callout",
          kind: "warn",
          title: "Hardest routine in the book",
    ...
    return node`,
        },
        {
          type: "callout",
          kind: "perf",
          text: "Because height ≤ 2·log(n+1), search is guaranteed O(log n) — the whole point of colouring.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Every RB mutation preserves properties 1, 3, and 5 automatically. Only property 4 (no red-red) and property 2 (root is black) can be broken temporarily — insert_fixup and delete_fixup restore them in O(log n) time. The colour system is chosen precisely so that this repair is bounded in rotations.",
        },
      ],
    },
    {
          ...
          rows: [
            {
              ...
              time: "O(log n)",
              space: "O(1)",
              note: "Slightly higher constant than AVL",
            },
            {
              op: "Insert",
              time: "O(log n)",
              space: "O(1)",
              note: "≤ 2 rotations + O(log n) recolouring",
            },
            {
              op: "Delete",
              time: "O(log n)",
              space: "O(1)",
              note: "≤ 3 rotations + O(log n) recolouring",
            },
            {
              op: "Space",
              time: "—",
              space: "O(n)",
              note: "One colour bit + parent pointer per node",
            },
          ],
        },
      ],
...
class RBTree:
    ...
    def inorder(self):
        ...
        },
        {
          type: "callout",
          kind: "tip",
          title: "Delete omitted for readability",
      ...
      sections: [
        {
          type: "rbPlayground",
          caption:
            "Insert a sequence like 10, 20, 30, 15, 25, 5 and observe how colouring keeps height low.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "dryRun",
          headers: ["Step", "Insert", "Case", "Result"],
          rows: [
            ...
            [
              "3",
              "30",
              "Uncle NIL, outer right — left-rotate at 10, swap colours",
              "20(B), 10(R), 30(R)",
            ],
            [
              "4",
              "15",
              "Uncle 30 is red — recolour: 10, 30 → B; 20 → R; root repaint → B",
              "20(B), 10(B), 30(B), 15(R)",
            ],
          ],
        },
    ...
    },
    {
      ...
      sections: [
        ...
        {
          type: "theory",
          text: "It's a bookkeeping convenience. A black root makes property 5 (equal black-height) count uniformly from the top, and it means insert_fixup can terminate simply by painting the root black after the loop.",
        },
        { type: "heading", text: "Why start new nodes red instead of black?" },
        {
          type: "theory",
          text: "Inserting a red node can only break property 4 (no red-red), which we can fix locally. Inserting a black node would immediately break property 5 on every path through the new node — much harder to repair.",
        },
        { type: "heading", text: "AVL vs Red-Black — how do I actually choose?" },
        {
          type: "theory",
          text: "If searches vastly outnumber mutations, prefer AVL: it's ~10% shorter on average and cache access wins. If mutations are common (queues, schedulers, ordered maps), prefer Red-Black: its bounded rotation count means lower worst-case latency per operation.",
        },
        { type: "heading", text: "How many rotations per insert / delete?" },
        {
          type: "theory",
          text: "Insert: at most 2 rotations, plus O(log n) recolourings. Delete: at most 3 rotations, plus O(log n) recolourings. Recolouring is cheap — a single memory write — so real-world mutation is fast.",
        },
      ],
    },
    {
          ...
          groups: [
            {
              ...
              items: [
                {
                  title: "LC 703 · Kth Largest in Stream (SortedList)",
                  url: "https://leetcode.com/problems/kth-largest-element-in-a-stream/",
                  difficulty: "Easy",
                  pattern: "Ordered container",
                },
                {
            ...
            },
            {
              ...
              items: [
                {
                  title: "LC 220 · Contains Duplicate III (SortedContainers)",
                  url: "https://leetcode.com/problems/contains-duplicate-iii/",
                  difficulty: "Medium",
                  pattern: "Ordered window",
                },
                {
                  title: "LC 855 · Exam Room",
                  url: "https://leetcode.com/problems/exam-room/",
                  difficulty: "Medium",
                  pattern: "Ordered set",
                },
                {
                  title: "LC 729 · My Calendar I",
                  url: "https://leetcode.com/problems/my-calendar-i/",
                  difficulty: "Medium",
                  pattern: "Interval tree",
                },
              ],
            },
            {
              ...
              items: [
                {
                  title: "LC 315 · Count of Smaller Numbers After Self",
                  url: "https://leetcode.com/problems/count-of-smaller-numbers-after-self/",
                  difficulty: "Hard",
                  pattern: "Order statistic tree",
                },
                {
                ...
                {
                  title: "LC 732 · My Calendar III",
                  url: "https://leetcode.com/problems/my-calendar-iii/",
                  difficulty: "Hard",
                  pattern: "Sweep + ordered map",
                },
              ],
            },
          ],
          ...
          items: [
            {
              ...
              choices: [
                ...
                "Property 5 (black-height)",
                "None",
              ],
              answer: 1,
              explain: "Property 4 forbids two consecutive red nodes on any path.",
            },
            {
              q: "What is the maximum height of an RB tree with n nodes?",
              choices: ["log₂(n)", "1.44·log₂(n)", "2·log₂(n+1)", "n"],
              answer: 2,
              explain: "The loose balance guarantees height ≤ 2·log₂(n+1).",
            },
            {
              q: "How many rotations can a single insert cause?",
              choices: ["0", "≤ 2", "≤ 3", "O(log n)"],
              answer: 1,
              explain: "Insert triggers at most two rotations plus O(log n) recolourings.",
            },
            {
              q: "In insert_fixup, when the uncle is red we…",
              choices: [
                "Rotate on the grandparent",
                "Recolour parent, uncle, grandparent and recurse",
                "Swap the node with its parent",
                "Do nothing",
              ],
              answer: 1,
              explain: "The recolour case pushes the violation up two levels — no rotation.",
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          items: [
            {
              label: "CLRS — Introduction to Algorithms, Ch. 13",
            ...
            {
              label: "Linux kernel rbtree.h",
              url: "https://github.com/torvalds/linux/blob/master/include/linux/rbtree.h",
            },
            {
              label: "Sedgewick — Left-leaning Red-Black Trees",
...
export const V_BTREE: TreeVariantMeta = {
  ...
  title: "B-Tree",
  tagline:
    "A multi-way balanced search tree tuned for block storage — the backbone of every database index.",
  lessons: [
    {
      slug: "introduction",
      title: "Introduction",
      eyebrow: "B-Tree · 1",
      description:
        "A generalisation of the BST where each node holds many keys and points to many children.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        {
          type: "theory",
          text: "Bayer & McCreight introduced the B-Tree in 1972 for disk-resident indexes. By packing hundreds of keys into one node, a B-Tree collapses the tree height so that a lookup over 10⁸ records touches only 4–5 disk blocks. Every relational database, most filesystems, and many key-value stores use a B-Tree variant.",
        },
        {
          type: "callout",
          kind: "info",
          title: "Why not a BST on disk?",
          text: "A BST with 10⁸ keys has height ~27. On disk that's 27 seeks per lookup ≈ 270 ms. A B-Tree with t=100 does 5 seeks — ~50 ms — because every seek reads a whole block full of keys.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "A node is sized to fit exactly in a disk page (typically 4 KiB or 8 KiB). All keys and child pointers are packed contiguously so a single read yields the entire node.",
        },
        {
          type: "memoryDiagram",
          nodes: [
    ...
    def __init__(self, t: int = 3):
        ...
        },
        {
          type: "callout",
          kind: "tip",
          text: "Databases pick t so 2t·pointer_size ≈ page size — usually a few hundred.",
        },
      ],
    },
    {
    ...
    return search(node.children[i], k)`,
        ...
        {
          type: "theory",
          text: "Cost = O(log_t n) disk reads × O(log t) in-memory binary search per node = O(log n) total comparisons but only O(log_t n) I/O.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Classic (proactive) insertion splits any node with 2t−1 keys before descending into it. This guarantees a single top-down pass with no walk back up.",
        },
        {
          type: "code",
          code: `def insert(tree, k):
    r = tree.root
    if r.is_full(tree.t):
...
def _insert_nonfull(node, k, t):
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          type: "callout",
          kind: "warn",
          text: "Deletion is the reason many textbooks show B-Trees as insertion-only. Real implementations (LMDB, SQLite) all handle borrow + merge.",
        },
      ],
    },
    {
          ...
          rows: [
            {
              op: "Search",
              time: "O(log_t n)",
              space: "O(1) iter · O(h) rec",
              note: "t=100 → h≈5 for n=10⁸",
            },
    ...
    },
    {
      ...
      eyebrow: "B-Tree · 15",
      description:
        "A self-contained B-Tree with insert, search, in-order traversal, and delete stub.",
      difficulty: "Advanced",
      readMinutes: 6,
      sections: [
        {
...
if __name__ == "__main__":
    ...
    },
    {
      ...
      sections: [
        {
          type: "dryRun",
          headers: ["Step", "Insert", "Root", "Notes"],
          rows: [
          ...
          groups: [
            {
              ...
              items: [
                {
                  title: "Implement search on a given B-Tree node",
                  url: "https://www.geeksforgeeks.org/b-tree-set-1-introduction-2/",
                  difficulty: "Easy",
                  pattern: "Traversal",
                },
                {
                  title: "In-order traversal of a B-Tree",
                  url: "https://www.geeksforgeeks.org/traversal-in-tree/",
                  difficulty: "Easy",
                },
              ],
            },
            ...
            },
            {
              ...
              items: [
                {
                  title: "Build a disk-backed B-Tree (CMU 15-445 lab)",
                  url: "https://15445.courses.cs.cmu.edu/fall2022/project2/",
                  difficulty: "Hard",
                  pattern: "Systems",
                },
              ],
      ...
      sections: [
        {
          ...
          items: [
            ...
            {
              label: "CLRS — Chapter 18: B-Trees",
              url: "https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/",
            },
            {
              label: "CMU 15-445 — Tree Indexes",
              url: "https://15445.courses.cs.cmu.edu/fall2022/notes/07-treeindexes.pdf",
            },
            {
              label: "PostgreSQL — B-Tree implementation",
...
export const V_BPLUS: TreeVariantMeta = {
  ...
  title: "B+ Tree",
  tagline:
    "A B-Tree where data lives only in the leaves and leaves form a linked list — the workhorse of every RDBMS.",
  lessons: [
    {
      slug: "introduction",
      title: "Introduction",
      ...
      sections: [
        {
          type: "theory",
          text: "In a B+ Tree, internal nodes hold only routing keys — no data. All records live in the leaves, which are chained in a doubly linked list. That single design change turns range queries into a straight-line walk instead of an in-order traversal, which is exactly what SQL's `WHERE col BETWEEN a AND b` and `ORDER BY col` need.",
        },
      ],
    },
    {
...
def get(tree, k):
    ...
    },
    {
      ...
      eyebrow: "B+ Tree · 8",
      description:
        "Insert into the leaf; if it overflows, split and propagate a copy of the split key up.",
      difficulty: "Advanced",
      readMinutes: 4,
      sections: [
        {
        ...
        },
        {
          ...
          kind: "info",
          title: "Copy vs move",
          text: "Leaves copy their first key up (data must remain in the leaf). Internal nodes move the median up (they carry no data).",
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          type: "callout",
          kind: "warn",
          text: "Many production systems (InnoDB, LMDB) skip merges and let leaves stay half-empty until a background page-reorg.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def range_scan(tree, lo, hi):
    ...
    return out`,
        },
        {
          type: "callout",
          kind: "perf",
          text: "Range scan cost = O(log_t n + k) but the k term is a sequential I/O — orders of magnitude cheaper than random access on disk or SSD.",
        },
      ],
    },
    {
...
if __name__ == "__main__":
    ...
    },
    {
      ...
      sections: [
        {
          type: "dryRun",
          headers: ["Step", "Insert", "Root", "Leaf chain", "Notes"],
          rows: [
          ...
          groups: [
            {
              ...
              items: [
                {
                  title: "Explain B+ Tree structure with diagrams",
                  url: "https://www.geeksforgeeks.org/introduction-of-b-tree/",
                  difficulty: "Easy",
                },
                {
                  title: "Walk a leaf chain to answer a range query",
                  url: "https://www.geeksforgeeks.org/b-tree-set-1-introduction-2/",
                  difficulty: "Easy",
                  pattern: "Range",
                },
            ...
            },
            {
              ...
              items: [
                {
                  title: "Implement B+ Tree insert with leaf splits",
                  url: "https://www.geeksforgeeks.org/insertion-in-a-b-tree/",
                  difficulty: "Medium",
                  pattern: "Split + copy-up",
                },
                {
                  title: "Implement a range-scan iterator",
      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              choices: ["O(k · log_t n)", "O(log_t n + k)", "O(n)", "O(k²)"],
              answer: 1,
              explain: "One descent, then a linear walk over k leaf entries.",
            },
            {
              q: "When a leaf splits, its median key is…",
              choices: ["Moved up", "Copied up", "Discarded", "Rotated to a sibling"],
              answer: 1,
      ...
      sections: [
        {
          ...
          items: [
            {
              label: "Comer — The Ubiquitous B-Tree (1979)",
              url: "https://carlosproal.com/ir/papers/p121-comer.pdf",
            },
            {
              label: "InnoDB B+ tree overview",
            ...
            {
              label: "SQLite File Format — B-tree pages",
