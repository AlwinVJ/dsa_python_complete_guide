...
export const V_TRIE: TreeVariantMeta = {
  ...
  title: "Trie",
  tagline:
    "A tree indexed by character — the shape behind autocomplete, spellcheck, and IP routing.",
  lessons: [
    {
      slug: "introduction",
      title: "Introduction",
      eyebrow: "Trie · 1",
      description:
        "A prefix tree — each edge is a character; each path from the root spells a stored string.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        {
          type: "theory",
          text: "A trie (pronounced 'try', from *retrieval*) stores strings by their prefixes. Insert 'cat', 'car', and 'cart', and you share the 'ca' prefix once. Lookup, prefix search, and autocomplete are all linear in the KEY length — independent of the dictionary size. That is the property no hash table can match.",
        },
        {
          type: "tree",
          root: {
                ...
                children: [
                  {
                    ...
                    children: [
                      { id: "cat", label: "t", color: "visited", badge: "end" },
                      {
                        ...
                        color: "visited",
                        badge: "end",
                        children: [{ id: "cart", label: "t", color: "visited", badge: "end" }],
                      },
                    ],
                  },
                ],
      ...
      sections: [
        ...
        },
        {
          ...
          rows: [
            [
              "Alphabet Σ",
              "Set of possible characters (26 for a-z, 128 for ASCII, unbounded for Unicode).",
            ],
    ...
    },
    {
      ...
      sections: [
        {
          type: "table",
          headers: ["Representation", "Space per node", "Pros", "Cons"],
          rows: [
            [
              "dict {ch: node}",
              "≈ 80B empty, grows",
              "Sparse-friendly, any alphabet",
              "Slower dispatch, hashing overhead",
            ],
            [
              "list of 26/128 pointers",
              "26 · pointer size",
              "O(1) lookup, cache friendly",
              "Wastes space when children are sparse",
            ],
            [
              "Compressed (radix)",
              "≈ label length",
              "Best space for sparse dictionaries",
              "Trickier code, edge splits",
            ],
          ],
        },
        {
    ...
    node.is_end = True`,
        },
        {
          type: "callout",
          kind: "tip",
          text: "Using `dict.setdefault` avoids the two-line 'if not in, create' idiom — one dict lookup instead of two.",
        },
      ],
    },
    {
...
def _walk(self, s: str):
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def starts_with(self, prefix: str) -> bool:
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def delete(self, word: str) -> bool:
    def go(node, i):
        if i == len(word):
    ...
    return go(self.root, 0)`,
        },
        {
          type: "callout",
          kind: "warn",
          text: "Never prune a node whose is_end is True or which still has children — that would silently erase other words.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def autocomplete(self, prefix: str, limit: int = 10) -> list[str]:
    ...
    return out`,
        ...
        {
          type: "triePlayground",
          seed: ["cat", "car", "cart", "care", "cargo", "dog", "dove"],
          caption: "Type a prefix and watch the trie light up matching paths.",
        },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          rows: [
            ...
            { op: "Autocomplete top-k", time: "O(L + k · L)", note: "DFS bounded by k results" },
            {
              op: "Total space",
              time: "O(N · Σ)",
              note: "N = total chars stored — compressed trie beats it",
            },
          ],
        },
      ],
...
if __name__ == "__main__":
    ...
    },
    {
      ...
      sections: [
        {
          type: "dryRun",
          headers: ["Step", "Op", "Root children", "Notes"],
          rows: [
          ...
          groups: [
            {
              ...
              items: [
                ...
                {
                  title: "LC 720 · Longest Word in Dictionary",
            ...
            },
            {
              ...
              items: [
                {
                  title: "LC 211 · Add and Search Word",
            ...
            },
            {
              ...
              items: [
                ...
                {
                  title: "LC 1032 · Stream of Characters",
      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              choices: [
                "Always remove every node on its path",
                "Never touch the tree — just flip is_end",
                "Flip is_end, then prune only childless, non-end nodes on the way up",
                "Rebuild the whole trie",
              ],
              answer: 2,
              explain:
                "Prune upward only while a node is childless and not an end for another word.",
            },
            {
              q: "Which structure beats a trie for exact-match membership?",
              choices: ["Sorted array", "Hash set", "Segment tree", "Linked list"],
              answer: 1,
  ...
  lessons: [
    {
      ...
      description:
        "A balanced binary tree over array intervals — each node stores an aggregate over its range.",
      difficulty: "Intermediate",
      readMinutes: 4,
      sections: [
        {
          type: "theory",
          text: "A segment tree over an n-element array uses O(n) space and answers any associative range query (sum, min, max, gcd, xor, mod-p sum…) in O(log n). Point updates are O(log n) too, and with lazy propagation whole-range updates are O(log n) as well. It is the workhorse structure of competitive programming.",
        },
        {
          type: "callout",
          kind: "info",
          title: "When to reach for a segment tree",
          text: "You have an array, you need range queries AND point/range updates, and the operation is associative. If it's only sum, a Fenwick tree is smaller and faster.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Store the tree in a flat array `t` of size 4n. Node 1 is the root; node i's children are 2i and 2i+1. This is the same trick as a binary heap and avoids per-node allocation.",
        },
        {
          type: "memoryDiagram",
          nodes: [
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `# The 'node' is just an index into a flat array.
...
# For any associative op f: t[node] = f(t[2*node], t[2*node+1])`,
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          title: "sum segment tree — build",
          code: `def _build(self, a, node, l, r):
    if l == r:
        self.t[node] = a[l]
        return
    m = (l + r) // 2
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def query(self, ql, qr, node=1, l=0, r=None):
    ...
    },
    {
      ...
      sections: [
        {
          type: "code",
          code: `def update(self, i, v, node=1, l=0, r=None):
    if r is None: r = self.n - 1
    if l == r:
        self.t[node] = v
        return
    ...
    },
    {
      ...
      description:
        "Applying a range update leaf-by-leaf is O(n) — that's what lazy propagation fixes.",
      difficulty: "Intermediate",
      readMinutes: 2,
      sections: [
        {
          type: "theory",
          text: "The naïve range update walks every leaf in [l, r] and calls point_update — O((r−l+1) · log n). Fine for tiny ranges, terrible in general. Lazy propagation gets this down to O(log n).",
        },
      ],
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "Store a pending 'add x to every element in this range' on each node. The pending value is pushed down only when a child is actually visited — turning O(n) range updates into O(log n).",
        },
        {
          type: "code",
    ...
    },
    {
      ...
      sections: [
        {
          type: "theory",
          text: "You rarely traverse a segment tree explicitly. Every query and update is a DFS that visits O(log n) nodes because at most 2 nodes per level are partially covered by the query interval.",
        },
      ],
    },
    {
...
if __name__ == "__main__":
    ...
    },
    {
      ...
      sections: [
        {
          type: "dryRun",
          headers: ["Step", "Op", "Nodes touched", "Result"],
          rows: [
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  difficulty: "Hard",
                  pattern: "Coord-compress + BIT/seg",
                },
                {
                  title: "LC 699 · Falling Squares",
                  url: "https://leetcode.com/problems/falling-squares/",
                  difficulty: "Hard",
                  pattern: "Range assign",
                },
              ],
            },
            {
      ...
      sections: [
        {
          ...
          items: [
            ...
            {
              label: "Codeforces EDU — Segment Tree series",
              url: "https://codeforces.com/edu/course/2/lesson/4",
            },
            {
              label: "CSES Problem Set — Range Queries section",
  ...
  lessons: [
    {
      ...
      eyebrow: "Fenwick · 1",
      description:
        "A Binary Indexed Tree (BIT) answers prefix-sum queries and point updates in O(log n).",
      difficulty: "Intermediate",
      readMinutes: 3,
      sections: [
        {
          type: "theory",
          text: "The Fenwick Tree — invented by Peter Fenwick in 1994 — stores partial sums indexed by the lowest set bit of each index. It uses only n words of memory (vs 4n for a segment tree) and has a tiny constant factor. If you only need sums, prefer BIT.",
        },
      ],
    },
    {
