...
export const LL_REVISION: LLLesson[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: "theory",
        text: "Refer to the comparison table above when you need to pick a variant. In practice: default to Singly, upgrade to Doubly when you need O(1) delete-by-node, use Circular when the data itself is a ring.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        items: [
          {
            q: "Which variant supports O(1) delete when you already hold a pointer to the node?",
            choices: ["Singly", "Doubly", "Circular singly", "None"],
            answer: 1,
            explain: "You need `.prev` to unlink without a full traversal.",
          },
          {
            q: "Floyd's cycle detection runs in…",
            choices: [
              "O(n) time · O(1) space",
              "O(n) time · O(n) space",
              "O(n log n) time",
            ...
            answer: 0,
            explain: "Two pointers, no auxiliary set.",
          },
          {
            q: "What terminates traversal in a NON-circular list?",
            choices: ["An empty node", "cur is None", "A special sentinel value", "len == 0"],
            answer: 1,
            explain: "The tail's `next` is None.",
          },
          {
            q: "Best sort for a singly linked list is…",
            choices: ["Quicksort", "Insertion sort", "Merge sort", "Bubble sort"],
            answer: 2,
            explain: "Merge sort works with O(1) extra list ops and gives O(n log n).",
          },
          {
            q: "In a circular doubly linked list, `head.prev` is…",
            choices: ["None", "The tail node", "Head itself", "Undefined"],
            answer: 1,
            explain: "That's the whole reason CDLL gives O(1) tail access.",
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        items: [
          {
            label: "CPython list implementation notes",
            url: "https://github.com/python/cpython/blob/main/Include/cpython/listobject.h",
          },
          {
            label: "collections.deque (docs)",
            url: "https://docs.python.org/3/library/collections.html#collections.deque",
          },
          {
            label: "MIT 6.006 · Lecture: Sequences",
            url: "https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/",
          },
          {
            label: "CLRS · Chapter 10: Elementary Data Structures",
            url: "https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/",
          },
          {
            label: "LeetCode · Linked List problem tag",
  ...
  },
  {
    ...
    sections: [
      {
        type: "theory",
        text: "Linked lists are the backbone of Stacks, Queues, and Hash-table chaining. Any of those modules will feel familiar now that you understand pointer manipulation.",
      },
      {
        type: "theory",
        bullets: [
      ...
      },
      {
        type: "callout",
        kind: "did",
        title: "Suggested next module",
        text: "Stacks — you'll implement one in ~30 lines using the linked-list skills you just built.",
      },
    ],
  },
];
