...
import { ArrowUpDown, ArrowRight, Network, Search } from "lucide-react";

export const Route = createFileRoute("/playgrounds/")({
  head: () => ({
    meta: [
      { title: "Playgrounds — DSA with Python" },
      { name: "description", content: "Interactive DSA playgrounds — experiment with sorting, searching, and graphs visually." },
    ],
  }),
  component: Page,
});
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-semibold">Searching Playground</div>
              <div className="text-xs text-muted-foreground">6 algorithms · animations · bounds</div>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
            Linear, Binary, Jump, Interpolation, Exponential, and Ternary Search — visualize search intervals, target comparisons, and index steps.
          </p>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">
            ...
            step controls, comparisons/swaps, and Python code.
          </p>
          <span className="mt-auto inline-flex items-center gap-1 text-sm font-medium text-[color:var(--brand)]">
            Launch playground <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" />
          </span>
