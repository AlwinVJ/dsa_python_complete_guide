  ...
  head: () => ({
    meta: [
      { title: "Space Complexity Cheat Sheet — Python Lists & Algorithms" },
      {
        name: "description",
        content:
          "Auxiliary space usage for Python list operations, sorting, searching, and common interview problems.",
      },
    ],
  }),
  component: Page,
...
const rows: ComplexityRow[] = [
  {
    ...
    aux: "O(1)",
    note: "Amortized; occasional realloc.",
  },
  ...
  { name: "del lst[i]", category: "List operations", aux: "O(1)", note: "In place." },
  {
    ...
    category: "List operations",
    aux: "O(n)",
    note: "New shallow list of pointers.",
  },
  { name: "reverse()", category: "List operations", aux: "O(1)", note: "Swaps in place." },
  {
    name: "reversed(lst) → list",
    category: "List operations",
    aux: "O(n)",
    note: "Materialized new list.",
  },
  { name: "Slice lst[a:b]", category: "List operations", aux: "O(k)", note: "k = slice length." },
  {
    ...
    category: "List operations",
    aux: "O(1)",
    note: "Amortized; grows in place.",
  },
  {
    name: "Concatenation a + b",
    category: "List operations",
    aux: "O(n + k)",
    note: "New list is allocated.",
  },
...

  {
    ...
    aux: "O(n)",
    note: "Dict of value → index.",
  },
  {
    name: "Product Except Self",
    category: "Interview problems",
    aux: "O(1)",
    note: "Excluding the output array.",
  },
  {
    name: "Frequency Counter",
    category: "Interview problems",
    aux: "O(k)",
    note: "k = distinct elements.",
  },
  {
    name: "Kadane's Algorithm",
    category: "Interview problems",
    aux: "O(1)",
    note: "Two running variables.",
  },
  { name: "Prefix Sum", category: "Interview problems", aux: "O(n)", note: "Prefix array." },
  {
    ...
    category: "Interview problems",
    aux: "O(1)",
    note: "Or O(k) if tracking a window set.",
  },
  {
    name: "Merge Sorted Arrays",
    category: "Interview problems",
    aux: "O(n + m)",
    note: "New output array.",
  },
  {
    name: "Rotate Array (reverse trick)",
    category: "Interview problems",
    aux: "O(1)",
    note: "In place.",
  },
  ...
  return (
    <PageShell>
      ...
      <Callout kind="info" title="Auxiliary vs total space">
        <p>
          <b>Auxiliary space</b> is the <i>extra</i> memory an algorithm allocates on top of its
          input. Total space would include the input itself (usually O(n) for a list of n elements).
        </p>
      </Callout>
      ...
      <Callout kind="perf" title="Recursive vs iterative">
        <p>
          Recursive versions of the same algorithm pay for the call stack. Binary search costs O(log
          n) recursive frames; iterative binary search is O(1). Convert to a loop when the depth
