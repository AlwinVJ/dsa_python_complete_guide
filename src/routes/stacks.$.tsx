...
export const Route = createFileRoute("/stacks/$")({
  ...
  head: ({ params }) => {
    ...
    const title = r ? `${r.lesson.title} — Stacks — DSA with Python` : "Stacks — DSA with Python";
    return {
      meta: [
        { title },
        {
          name: "description",
          content: r?.lesson.description ?? "Stacks in Python — animated, interactive lessons.",
        },
