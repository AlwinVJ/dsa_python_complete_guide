...
export const Route = createFileRoute("/queues/interview")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated queue interview questions from theory to sliding-window and FAANG-style design — with Python solutions, complexity, and related lessons." },
      { property: "og:title", content: "Queues — Interview Questions · DSA with Python" },
      { property: "og:description", content: "Queue interview questions organised by difficulty with Python solutions." },
    ],
  }),
